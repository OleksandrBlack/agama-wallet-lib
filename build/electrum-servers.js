...
var electrumServers = {
  safe: {
    txfee: 10000,
    serverList: ['local.support:10001:tcp', 'electrum.safc.cc:10001:tcp']
  },
  btg: {
    txfee: 10000,
  ...
  zcl: {
    txfee: 1000,
    serverList: ['local.support:40001:tcp']
  },
  btcz: {
    txfee: 10000,
    serverList: ['local.support:10002:tcp', 'electrum.safc.cc:10002:tcp']
  },
  btcp: {
    txfee: 10000,
